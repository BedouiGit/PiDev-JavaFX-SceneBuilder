...
public class CardTags {
    ...
    private test.Controllers.Tags.AffichageTags affichageTagsController;



    public void setAffichageTagsController(test.Controllers.Tags.AffichageTags controller) {
