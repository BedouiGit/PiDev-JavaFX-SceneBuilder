...
public class Login {
    ...
    public void loginButtonOnAction(ActionEvent e) throws IOException, SQLException
    {
        ...
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/fxml/UserFxml/profile.fxml"));
    ...
    private void forgetPassword(ActionEvent event){
        ...
        try {
            resetPasswordInterface = FXMLLoader.load(getClass().getResource("/fxml/UserFxml/forgetPassword.fxml"));
    ...
    void goToSignup(ActionEvent event) {
        ...
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/fxml/UserFxml/signup.fxml"));
    ...
    public void loginfaceid(ActionEvent actionEvent) throws IOException {
        ...
        FXMLLoader load = new FXMLLoader(getClass().getResource("/fxml/UserFxml/loginfaceid.fxml"));
