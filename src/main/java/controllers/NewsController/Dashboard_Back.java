...
public class Dashboard_Back implements Initializable {
    ...
    private void loadPosts() {
        Platform.runLater(() -> {
            ...
            for (Posts post : posts) {
                ...
                fxmlLoader.setLocation(getClass().getResource("/fxml/NewsFxml/back_office/item.fxml"));
                try {
    ...
    private void updateEventCards(List<Posts> searchResults) {
        ...
        for (Posts post : searchResults) {
            try {
                FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/fxml/NewsFxml/back_office/item.fxml"));
                VBox vBox = fxmlLoader.load();
               ShowPost_back showPost = fxmlLoader.getController();
                showPost.setData(post);
                showPost.setDashboardController(this);
    ...
    private void openAddPostInterface(ActionEvent event) {
        try {
            ...
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/fxml/NewsFxml/back_office/AjouterPost.fxml"));
    ...
    private void showStats(ActionEvent event) {
        try {
            ...
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/fxml/NewsFxml/back_office/Stats.fxml"));
            Parent root = loader.load();
    ...
    void showComments(ActionEvent event) {
        try {
            ...
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/fxml/NewsFxml/back_office/ShowComments_back.fxml"));
            Parent root = loader.load();
