...
public class ShowPost {
    ...
    void OnCommentContainerClicked(MouseEvent event) {
        ...
        try {
            ...
            FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/fxml/NewsFxml/front_office/AddComments.fxml"));
    ...
    void editPost(MouseEvent event) {
        try {
            ...
            FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/fxml/NewsFxml/front_office/editPost.fxml"));
            Parent root = fxmlLoader.load();
