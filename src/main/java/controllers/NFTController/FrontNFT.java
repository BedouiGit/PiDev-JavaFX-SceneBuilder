...
public class FrontNFT {
    ...
    void initialize() {
        ...
        try {
            for (NFT nft : topnfts) {
                FXMLLoader loader = new FXMLLoader(getClass().getResource("/fxml/NFTFxml/FrontOffice/Card.fxml"));
            ...
            for (NFT nft : nfts) {
                FXMLLoader loader = new FXMLLoader(getClass().getResource("/fxml/NFTFxml/FrontOffice/nftcontainer.fxml"));
